...
//go:generate minimock -i github.com/Timofey335/platform_common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Timofey335/platform_common/pkg/db"
